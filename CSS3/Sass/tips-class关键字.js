/* 
常见class关键词
布局类：header, footer, container, main, content, aside, page, section, scroll-view
包裹类：wrap, inner, outer, inner-wrap
...
页面结构
容器: container/wrap, wrapper, header, nav, content, main, column, aside, sidebar, footer

导航
导航：nav, subnav, topnav, menu, submenu

其他
  &__thumb, &__title, &__desc, &__info, source, tips, time, ellipsis

功能
标志：logo, login, loginbar, register
登陆：login
登录条：loginbar
注册：regsiter
产品：products
