export default {
	...
	//ES6-7: Int8Array, Uint8Array, Int16, Int32, Float16
    methods: {
	  //keys, values, entries, find, fill, copyWithin | from, of
      Array: {
      ...
      //keys, values, entries, assign, is, setPrototypeOf, getOwnPropertyDescriptors
      Object: {
	  ...
	  //repeat, padStart, padEnd, startsWith, endsWith, includes
      String: {
        at: "string/at",
