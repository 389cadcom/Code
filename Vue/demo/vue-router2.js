/*
 1.配置					routes: []
 2.嵌套路由				children: []				template-->router-link | router-view
 3.动态路由				path: 'user/:id'
...
*/
//http://leenty.com/2016/12/18/vue2-6/   路由钩子设置title
//routes: options参数 props
{path: '', name:'', redirect:'', alias:'', meta:{checkAuth:}, component: Home |  components: { default:Home, b:Edit }, props:true}  

//props-->route.params 将会被设置为组件属性

//router-link标签的属性  linkActiveClass
//to, tag, replace, append, exact(route-link严格模式), active-class(会被路由统一设置覆盖)

:to = { path:'', name:'', params:{id:12}, query:{args:123} }
...
mode,
base,
linkActiveClass,		//active-class属性
